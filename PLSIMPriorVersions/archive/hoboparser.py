...
def hobo_process(hobo_1_np: dict, hobo_2_np: dict):  # output will be 15 minutes chunks
    ...
    if hobo_1_enabled:
        ...
        for (device, state), values in hobo_1_np.items():
            ...
            knownSlotCount = (values[-1][0] - values[0][0]) // (86400 // total_period)
...
'''
Sample SQL Table for data entry:
CREATE TABLE IF NOT EXISTS `ExampleDATAfloat` (
  ...
  `p17` float DEFAULT NULL,
  `p18` float DEFAULT NULL,
  `p19` float DEFAULT NULL,
  `p20` float DEFAULT NULL,
  `p21` float DEFAULT NULL,
  `p22` float DEFAULT NULL,
  `p23` float DEFAULT NULL,
  `p24` float DEFAULT NULL,
  `p25` float DEFAULT NULL,
  `p26` float DEFAULT NULL,
  `p27` float DEFAULT NULL,
  `p28` float DEFAULT NULL,
  `p29` float DEFAULT NULL,
  `p30` float DEFAULT NULL,
  `p31` float DEFAULT NULL,
  `p32` float DEFAULT NULL,
  `p33` float DEFAULT NULL,
  `p34` float DEFAULT NULL,
  `p35` float DEFAULT NULL,
  `p36` float DEFAULT NULL,
  `p37` float DEFAULT NULL,
  `p38` float DEFAULT NULL,
  `p39` float DEFAULT NULL,
  `p40` float DEFAULT NULL,
  `p41` float DEFAULT NULL,
  `p42` float DEFAULT NULL,
  `p43` float DEFAULT NULL,
  `p44` float DEFAULT NULL,
  `p45` float DEFAULT NULL,
  `p46` float DEFAULT NULL,
  `p47` float DEFAULT NULL,
  `p48` float DEFAULT NULL,
  `p49` float DEFAULT NULL,
  `p50` float DEFAULT NULL,
  `p51` float DEFAULT NULL,
  `p52` float DEFAULT NULL,
  `p53` float DEFAULT NULL,
  `p54` float DEFAULT NULL,
  `p55` float DEFAULT NULL,
  `p56` float DEFAULT NULL,
  `p57` float DEFAULT NULL,
  `p58` float DEFAULT NULL,
  `p59` float DEFAULT NULL,
  `p60` float DEFAULT NULL,
  `p61` float DEFAULT NULL,
  `p62` float DEFAULT NULL,
  `p63` float DEFAULT NULL,
  `p64` float DEFAULT NULL,
  `p65` float DEFAULT NULL,
  `p66` float DEFAULT NULL,
  `p67` float DEFAULT NULL,
  `p68` float DEFAULT NULL,
  `p69` float DEFAULT NULL,
  `p70` float DEFAULT NULL,
  `p71` float DEFAULT NULL,
  `p72` float DEFAULT NULL,
  `p73` float DEFAULT NULL,
  `p74` float DEFAULT NULL,
  `p75` float DEFAULT NULL,
  `p76` float DEFAULT NULL,
  `p77` float DEFAULT NULL,
  `p78` float DEFAULT NULL,
  `p79` float DEFAULT NULL,
  `p80` float DEFAULT NULL,
  `p81` float DEFAULT NULL,
  `p82` float DEFAULT NULL,
  `p83` float DEFAULT NULL,
  `p84` float DEFAULT NULL,
  `p85` float DEFAULT NULL,
  `p86` float DEFAULT NULL,
  `p87` float DEFAULT NULL,
  `p88` float DEFAULT NULL,
  `p89` float DEFAULT NULL,
  `p90` float DEFAULT NULL,
  `p91` float DEFAULT NULL,
  `p92` float DEFAULT NULL,
  `p93` float DEFAULT NULL,
  `p94` float DEFAULT NULL,
  `p95` float DEFAULT NULL,
  `p96` float DEFAULT NULL,
